if Code.ensure_loaded?(:hackney) do
  defmodule Tesla.Adapter.Hackney do
    ...
    - `:timeout` - Request timeout in milliseconds. This timeout applies to the entire
      request/response cycle. If not specified, defaults to hackney's default timeout.
    ...
    def call(env, opts) do
      ...
      # Map :timeout to :recv_timeout if provided, but don't override existing :recv_timeout
