defmodule Tesla.Middleware.OpentelemetryTimeoutTest do
  use ExUnit.Case, async: false

  defmodule Client do
    use Tesla

    plug Tesla.Middleware.OpentelemetryTimeout, timeout: 100
  ...
  defmodule DefaultTimeoutClient do
    ...
    plug Tesla.Middleware.OpentelemetryTimeout
    ...
    test "should keep original stacktrace information" do
      try do
        ...
        _ in RuntimeError ->
          ...
          assert Tesla.Middleware.OpentelemetryTimeoutTest.Client == last_module
